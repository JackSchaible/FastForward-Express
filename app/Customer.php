...
class Customer extends Model {
    ...
    public function parentCompany() {
        return $this->belongsTo('Customer', 'id', 'parent_id');
    }

    public function rateType() {
        return $this->hasOne('RateType', 'id', 'rate_type_id');
    }

    public function invoiceInterval() {
        return $this->hasOne('invoiceInterval', 'id', 'invoice_interval_id');
    }
    ...
    public function getDriverComm() {
        return $this->hasOne('Driver', 'id', 'driver_comm_id');
    }
}
